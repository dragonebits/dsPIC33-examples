...
{           
	...
	DACCTRL1L = 0x50; //CLKDIV 1:2; DACON disabled; DACSIDL disabled; FCLKDIV 1:1; CLKSEL FVCO/2 - System VCO Clock; 
	DACCTRL2L = 0x55; //TMODTIME 85; 
	DACCTRL2H = 0x8A; //SSTIME 138; 
	DAC1CONH = 0x00; //TMCB 0; 
	DAC1CONL = 0x820F; //CMPPOL Non Inverted; HYSPOL Falling Edge; HYSSEL 45mV; DACEN enabled; FLTREN disabled; CBE disabled; IRQM Interrupts are disabled; INSEL CMP1B; DACOEN enabled; 

	//Slope Settings
	SLP1CONH = 0x00; //HME disabled; PSE Negative; SLOPEN disabled; TWME disabled; 
	SLP1CONL = 0x101; //HCFSEL None; SLPSTRT PWM1 Trigger1; SLPSTOPB None; SLPSTOPA PWM1 Trigger2; 
	SLP1DAT = 0x7800; //SLPDAT 30720; 
	DAC1DATL = 0x00; //DACDATL 0; 
	DAC1DATH = 0x300; //DACDATH 768; 
